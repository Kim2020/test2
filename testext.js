(function(ext) {
    ...
    function getStatus(callback) {
        ...
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/96335e10-e038-11e9-a3fc-d311131c4cd30c769fae-d57d-4c8b-b01a-ff3127975617/status',
            dataType : 'jsonp',
            headers : {
    ...
    function classifyImage(imagedata, cacheKey, lastmodified, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/96335e10-e038-11e9-a3fc-d311131c4cd30c769fae-d57d-4c8b-b01a-ff3127975617/classify',
            dataType : 'json',
            type : 'POST',
    ...
    function storeImage(imagedata, label, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/96335e10-e038-11e9-a3fc-d311131c4cd30c769fae-d57d-4c8b-b01a-ff3127975617/train',
            dataType : 'json',
            method : 'POST',
            contentType : 'application/json',
            headers : {
    ...
    ext.return_label_0 = function () {
        return 'kehuishouwu';
    };
    ext.return_label_1 = function () {
        return 'qitalaji';
    };
    ext.return_label_2 = function () {
        return 'youhailaji';
    };
    ext.return_label_3 = function () {
        return 'chuyulaji';
    };

    var descriptor = {
        blocks : [
            [ 'R', '识别 image %s (label)', 'image_classification_label', 'image' ],
            ...
            [ 'r', 'youhailaji', 'return_label_2'],
            [ 'r', 'chuyulaji', 'return_label_3'],
            [ 'w', 'add training data %s to %m.labels', 'image_store', 'image', 'kehuishouwu'],
            [ 'w', 'add training data %s to %s', 'image_store', 'image', 'label']
        ],
        menus : {
            labels : [  'kehuishouwu',  'qitalaji',  'youhailaji',  'chuyulaji',  ]
        }
    };
